...
<body>
  ...
  <div class="row justify-content-center">
    ...
    ">
        ...
        <form action="simpan2.php" method="post" name="Flogin">
          <div class="row">
  <div class="col">
    <!-- Name input -->
    <div data-mdb-input-init class="form-outline">
      <input type="text" name="username" id="form8Example1" class="form-control" />
  ...
  <div class="col">
    <!-- Email input -->
    <div data-mdb-input-init class="form-outline">
      <input type="password" name="pw" id="form8Example2" class="form-control" />
...
<div class="row">
  <div class="col">
    <!-- Name input -->
    <div data-mdb-input-init class="form-outline">
      <input type="text" name="full_name" id="form8Example3" class="form-control" />
      <label class="form-label" for="form8Example3">Full name</label>
    </div>
  </div>
    <!-- Email input -->
    <div data-mdb-input-init class="form-outline">
      <input type="email" name="email" id="form8Example5" class="form-control" />
